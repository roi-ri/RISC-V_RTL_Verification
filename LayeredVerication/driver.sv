        ...
        case (stimulus_obj.instr_type) 
            R_TYPE: begin
                ...
                case (stimulus_obj.r_instr)
                    ADD: begin
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion ADD creada: %d", instr_wrd);
                    end 
                    SUB: begin 
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SUB creada: %d", instr_wrd);
                    end 
                    SLL:begin 
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SLL creada: %d", instr_wrd);
                    end 
                    SLT: begin 
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SLT creada: %d", instr_wrd); 
                    end 
                    SLTU: begin 
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SLTU creada: %d", instr_wrd);
                    end 
                    XOR: begin
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion XOR creada: %d", instr_wrd);
                    end 
                    SRL: begin 
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SRL creada: %d", instr_wrd);
                    end 
                    SRA: begin
                        r_instr.funct7 = 7'b0100000;
                        r_instr.funct3 = 3'b101;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion SRA creada: %d", instr_wrd);
                    end
                    OR: begin
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccionss
                         instr_wrd = r_instr; 
                        $display("Instruccion OR creada: %d", instr_wrd);
                    end 
                    AND: begin
                        r_instr.funct7 = 7'b0000000;
                        ...
                        //instruccion
                         instr_wrd = r_instr; 
                        $display("Instruccion AND creada: %d", instr_wrd);
                    end
            ...
            case (stimulus_obj.i_arith_instr) 
                ADDI: begin 
                    ...
                    $display("Instruccion ADDI creada: %d", instr_wrd);
                end 
                SLTI: begin 
                    ...
                    //instruccion
                    instr_wrd = i_arithmetic_instr; 
                    $display("Instruccion SLTI creada: %d", instr_wrd);
                end 
                SLTIU:begin
            ...
            // I_TYPE_SHIFT, I_TYPE_LOAD, I_TYPE_MEMORY_SYSTEM -> (Ver si se separa esta en dos), I_TYPE_JUMP,
